defmodule ScaleWorkers do
  @moduledoc """
  Documentation for ScaleWorkers.
  """
  ...
  def start_worker(name) do
    {:ok, pid} = Swarm.register_name(name, ScaleWorkers.ClusterSupervisor, :register, [name])
